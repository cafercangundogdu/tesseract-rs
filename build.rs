            ...
            build_or_use_cached(
                ...
                || {
                    ...
                    tesseract_config
                        ...
                        .define("CMAKE_GENERATOR_INSTANCE_PLATFORM", "ARM64")
                        ...
                        .define("CMAKE_CXX_FLAGS_RELEASE", "/MD")
                        .define("CMAKE_CXX_FLAGS_DEBUG", "/MDd")
                        .define("CMAKE_GENERATOR", "Visual Studio 17 2022")
                        .define("CMAKE_SYSTEM_NAME", "Windows")
                        .define("CMAKE_SYSTEM_VERSION", "10")
                        .define("CMAKE_POSITION_INDEPENDENT_CODE", "ON")
                        .define("CMAKE_C_FLAGS", " -nologo -MD -Brepro")
                        .define("CMAKE_C_FLAGS_RELEASE", " -nologo -MD -Brepro")
                        .define("CMAKE_ASM_FLAGS", " -nologo -MD -Brepro")
                        .define("CMAKE_ASM_FLAGS_RELEASE", " -nologo -MD -Brepro")
                        .define("CMAKE_CXX_FLAGS", "/EHsc /MP /DWIN32 /D_WINDOWS /D_ARM64 /D_ARM64_ -DUSE_STD_NAMESPACE /std:c++17")
                        .define("CMAKE_CXX_FLAGS_RELEASE", "/MD")
                        .define("CMAKE_CXX_FLAGS_DEBUG", "/MDd")
                        .define("CMAKE_C_FLAGS_RELEASE", "/MD")
                        .define("CMAKE_C_FLAGS_DEBUG", "/MDd")
                        .define("CMAKE_ASM_FLAGS_RELEASE", "/MD")
                        .define("CMAKE_ASM_FLAGS_DEBUG", "/MDd")
                        .define("CMAKE_EXE_LINKER_FLAGS", "/MACHINE:ARM64")
                        .define("CMAKE_SHARED_LINKER_FLAGS", "/MACHINE:ARM64")
                        .define("CMAKE_STATIC_LINKER_FLAGS", "/MACHINE:ARM64")
                        .define("CMAKE_MODULE_LINKER_FLAGS", "/MACHINE:ARM64");
